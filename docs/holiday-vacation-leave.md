...
The days of public holidays are by default greyed out in Exact.  However, you need to register holiday leave on this day and if in any case, you need to work on these days you can register these hours on your project.
